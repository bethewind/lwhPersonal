<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditStuWork.aspx.cs" Inherits="Admin_EditStuWork" %>
    ...
    <tr>
        <td>
            权限<asp:TextBox 
                ...
                ID="course" runat="server" Height="22px"></asp:TextBox>
            &nbsp;<input id="Button1" style="width: 84px" onclick = 'javascript:ShowDropdownList67()' type="button" value="点击选择分类&权限" /><div id = 'check2' style="width: 729px">
    ...
    <tr>
        <td>
            标题：<asp:TextBox ID="title" runat="server"></asp:TextBox>
                    &nbsp;&nbsp; 是否展示：<asp:CheckBox ID="isPro" runat="server" />
                    </td>
...
<div style="height: 28px"><div style =" float:left">权限<asp:TextBox 
                ID="steptbox1" runat="server" ReadOnly="True"></asp:TextBox>&nbsp;&nbsp;课程&amp;方向<asp:TextBox 
                ID="course1" runat="server" ReadOnly="True"></asp:TextBox>&nbsp;&nbsp;</div>
                
   </div>
<div style="height: 26px"><div id = 'stept' style ="float:left;"><input id="Button1" style="width: 117px" 
               onclick = 'javascript:ShowDropdownList67()' 
               type="button" value="点击选择分类&权限" /></div><div id = 'check2' style="width: 397px; float:left; height: 25px;">
            </div></div>
           <div style="height: 27px">标题：<asp:TextBox ID="title" runat="server" Width="215px"></asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 是否展示：<asp:CheckBox ID="isPro" runat="server" /></div>
