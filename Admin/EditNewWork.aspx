<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditNewWork.aspx.cs" Inherits="Admin_EditNewWork" %>
...
<div id = 'titlediv' 
        ...
        作业编辑</div>
        <div>权限:<asp:TextBox ID="txtStept" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp; 
            课程:<asp:TextBox ID="txtCourse" runat="server"></asp:TextBox>
             </div>
     <div id = 'Div2'>
